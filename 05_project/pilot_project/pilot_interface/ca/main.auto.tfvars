container_apps = [
  {
    name                           = "ca-worker-__#location_abbreviation#__-__#component_instance#__"
    ...
    template = {
      ...
      containers = [
        {
          name    = "ca-__#environment_abbr#__-pilot-processor-__#environment_instance#__"
          server  = "acr__#environment_abbr#____#service_id#__shared__#location_abbreviation#____#environment_instance#__.azurecr.io"
          image   = "worker"
          tag     = "latest"
          cpu     = 2.0
